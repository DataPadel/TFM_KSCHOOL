...
# APP STREAMLIT V3 (CREACION DE CLASE DE UTILIDAD "UTILIDADES" - CUIDADO CON MODIFICAR)
...
def cargar_dataframes():
    df_form = pd.read_json('df/dataframe_final_formulario.json', lines=True)
    df_palas = pd.read_csv('df/df_scaled_palas.csv')
